    ...
    return(
        <footer>
            <div className="footer-container">
                <div>Designed and Developed by Chris Ebube Roland</div>

                <div className="footer-links">
                    <ul>
                        <li>
                            <a href="https://twitter.com/chrisebuberolnd"  target="_blank" rel="noopener noreferrer">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/chrisebuberoland/" target="_blank" rel="noopener noreferrer">
                        ...
                        <li>
                            <a href="https://github.com/ChrisRoland" target="_blank" rel="noopener noreferrer">
